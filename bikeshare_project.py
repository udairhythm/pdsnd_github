...
def get_filters():
    ...
    while True:
        month = input('Input month to explore. Type month name of first six month in lower case or you can input "all" to get all month data: ')
        month = month.lower()
...
def user_stats(df, city):
    ...
    print('\nCalculating User Stats... just a moment\n')
    start_time = time.time()
